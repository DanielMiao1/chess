...
class Game:
	"""Game class"""
	def __init__(self, raise_errors=True, fen="rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", use_openings=False):
		"""Initialize"""
	...
	def updateOpening(self):
		"""Updates the opening if use_openings is True"""
